...
## 仓库说明
- 本人 Fork 的仓库：[ImmortalWrt](https://github.com/MMCKBZn/immortalwrt) [LibWrt](https://github.com/MMCKBZn/openwrt-6.x)，内容大体一致。
...
- 编译大概需要 1-2 小时，编译完成后在仓库主页Release对应 Tag 标签内下载固件。
